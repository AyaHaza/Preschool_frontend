...
class AuthController extends GetxController{
  User? user=User(id:4,token: "200|7IR0PyTskNURCGkgrkTzZTN0jc4oPQz4GOhC4GaO");
  ...
  Future<void> upload(img,id) async {
    try {
      ...
      final responseData = await Network.uploadProfile(img,user!.name,'${AuthNetwork.baseUrl}/profile/${id}');
