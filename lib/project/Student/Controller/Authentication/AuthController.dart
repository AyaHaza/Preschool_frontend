...
class AuthController extends GetxController{
  User? user=User(id:2,token: "83|MltJAisG6DreFfCwWPJVJcXthMsNqNFa5lFB5TU9");
  bool isAuth =false;
  ...
  Future<String?> login(String? password, String? name) async {
    try {
      ...
      print("errror  llllllllllllllloooggggggggggggggggggg");
      throw e;
    }
    catch (e) {
      print("errror  looooogpppppppppppppppp");
  ...
  Future<void> Fetch() async {
    try {
      ...
      user!.token=token;
      update();
    }  catch (e) {print("FFFFFFFFFFFFFFFFFFFFFFFFFetchhhhhhhhhhhhhhhhhhh     error");
      print(e);
      throw e;
